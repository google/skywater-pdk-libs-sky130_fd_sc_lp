...
`ifndef SKY130_FD_SC_LP__UDP_DFF_P_PP_PG_N_V
`define SKY130_FD_SC_LP__UDP_DFF_P_PP_PG_N_V
...
`ifdef NO_PRIMITIVES
`include "./sky130_fd_sc_lp__udp_dff_p_pp_pg_n.blackbox.v"
`else
primitive sky130_fd_sc_lp__udp_dff$P_pp$PG$N (
    Q       ,
    D       ,
    CLK     ,
    NOTIFIER,
...
`endif  // SKY130_FD_SC_LP__UDP_DFF_P_PP_PG_N_V
