...
`ifndef SKY130_FD_SC_LP__UDP_DFF_P_V
`define SKY130_FD_SC_LP__UDP_DFF_P_V
...
`ifdef NO_PRIMITIVES
`include "./sky130_fd_sc_lp__udp_dff_p.blackbox.v"
`else
primitive sky130_fd_sc_lp__udp_dff$P (
    Q  ,
    D  ,
    CLK
);
...
`endif  // SKY130_FD_SC_LP__UDP_DFF_P_V
