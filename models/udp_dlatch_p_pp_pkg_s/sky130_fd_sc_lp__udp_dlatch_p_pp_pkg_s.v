...
`ifndef SKY130_FD_SC_LP__UDP_DLATCH_P_PP_PKG_S_V
`define SKY130_FD_SC_LP__UDP_DLATCH_P_PP_PKG_S_V
...
`ifdef NO_PRIMITIVES
`include "./sky130_fd_sc_lp__udp_dlatch_p_pp_pkg_s.blackbox.v"
`else
primitive sky130_fd_sc_lp__udp_dlatch$P_pp$PKG$s (
    Q      ,
    D      ,
    GATE   ,
    SLEEP_B,
...
`endif  // SKY130_FD_SC_LP__UDP_DLATCH_P_PP_PKG_S_V
