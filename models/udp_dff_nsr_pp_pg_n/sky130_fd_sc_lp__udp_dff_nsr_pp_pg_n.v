...
`ifndef SKY130_FD_SC_LP__UDP_DFF_NSR_PP_PG_N_V
`define SKY130_FD_SC_LP__UDP_DFF_NSR_PP_PG_N_V
...
`ifdef NO_PRIMITIVES
`include "./sky130_fd_sc_lp__udp_dff_nsr_pp_pg_n.blackbox.v"
`else
primitive sky130_fd_sc_lp__udp_dff$NSR_pp$PG$N (
    Q       ,
    SET     ,
    RESET   ,
    CLK_N   ,
...
`endif  // SKY130_FD_SC_LP__UDP_DFF_NSR_PP_PG_N_V
