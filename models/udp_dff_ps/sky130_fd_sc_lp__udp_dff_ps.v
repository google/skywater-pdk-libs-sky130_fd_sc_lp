...
`ifndef SKY130_FD_SC_LP__UDP_DFF_PS_V
`define SKY130_FD_SC_LP__UDP_DFF_PS_V
...
`ifdef NO_PRIMITIVES
`include "./sky130_fd_sc_lp__udp_dff_ps.blackbox.v"
`else
primitive sky130_fd_sc_lp__udp_dff$PS (
    Q  ,
    D  ,
    CLK,
    SET
    ...
    table
     //  D  CLK  SET  :  Qt : Qt+1
         *   b    0   :  ?  :  -    ; // data event, hold unless CP==x
         ...
         1   ?    x   :  1  :  1    ; // Cover cases after S->X
         0   0    x   :  1  :  1    ; // Cover cases after S->X
         x   0    x   :  1  :  1    ; // Cover cases after S->X
    endtable
endprimitive
`endif // NO_PRIMITIVES

`default_nettype wire
`endif  // SKY130_FD_SC_LP__UDP_DFF_PS_V
