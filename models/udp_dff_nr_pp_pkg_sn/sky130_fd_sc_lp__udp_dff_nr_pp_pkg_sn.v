...
`ifndef SKY130_FD_SC_LP__UDP_DFF_NR_PP_PKG_SN_V
`define SKY130_FD_SC_LP__UDP_DFF_NR_PP_PKG_SN_V
...
`ifdef NO_PRIMITIVES
`include "./sky130_fd_sc_lp__udp_dff_nr_pp_pkg_sn.blackbox.v"
`else
primitive sky130_fd_sc_lp__udp_dff$NR_pp$PKG$sN (
    Q       ,
    D       ,
    CLK_N   ,
    RESET   ,
...
`endif  // SKY130_FD_SC_LP__UDP_DFF_NR_PP_PKG_SN_V
