...
`ifndef SKY130_FD_SC_LP__UDP_DLATCH_PR_V
`define SKY130_FD_SC_LP__UDP_DLATCH_PR_V
...
`ifdef NO_PRIMITIVES
`include "./sky130_fd_sc_lp__udp_dlatch_pr.blackbox.v"
`else
primitive sky130_fd_sc_lp__udp_dlatch$PR (
    Q    ,
    D    ,
    GATE ,
    RESET
...
`endif  // SKY130_FD_SC_LP__UDP_DLATCH_PR_V
